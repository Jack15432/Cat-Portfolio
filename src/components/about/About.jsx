      ...
      <div className="about__container container grid">
        ...
        <div className="about__data">
          ...
          <p ref={txtItem} className="about__description">
            As a professional cat, specializes in eating, sleeping and drinking. Although I'm lazy and I do nothing all day, everyone loves me!
          </p>

          <a download="" href={Essay} className="button button--flex">
            Download CV{" "}
            <svg
              class="button__icon"
